...
qpr_open_enc_query <- glue("CREATE TABLE PROD_QPR_OPEN_ENCOUNTER AS
                             ...
                             CASE WHEN k.SITE_PROV_MAP IS NOT NULL THEN k.SITE_PROV_MAP
                                  ...
                                  WHEN k.SITE_PROV_MAP IS NULL AND k.SITE_DEPT_MAP IS NULL THEN k.CAMPUS_DEPT_MAP
                                  ELSE k.CAMPUS_DEPT_MAP
                             END AS SITE_FINAL,
                             ...
                             FROM
                             (SELECT s.*, f.DEPT_MANAGED_PROV_MAP, f.SITE_PROV_MAP, f.OFFICE_PROCEDURE_PROV_MAP
                             FROM
                             (SELECT e.*, r.NPI
                             FROM
                             (SELECT c.*, d.CAMPUS AS CAMPUS_DEPT_MAP, d.CAMPUS_SPECIALTY AS CAMPUS_SPECIALTY_DEPT_MAP, d.CLINICAL_DEPT_DEPT_MAP,
                             d.CLINICAL_SUB_DEPT_DEPT_MAP, d.DEPT_MANAGED_DEPT_MAP, d.OFFICE_PROCEDURE_DEPT_MAP,
                             d.SITE_DEPT_MAP
                             FROM
                             ...
                             ON g.CLINICAL_DEPT_DEPT_MAP = h.CAMPUS_SPECIALTY_APPT_MAP AND g.PRC_NAME = h.PRC_NAME) k
                             ")
